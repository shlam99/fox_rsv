...
# Make directories
mkdir -p qc_reads aligned_bams consensus_sequences
...
########################################
echo "Step 1: Quality filtering with FiltLong..."
...
########################################
echo "Step 3: Consensus generation with samtools..."
...
########################################
# Step 4: Separate RSVA/RSVB consensus
########################################
echo "Step 4: Separate RSVA/RSVB consensus..."
...
step_complete "4" "Success!!: RSVA has ($RSVA_COUNT) sequences and RSVB has ($RSVB_COUNT) sequences"

echo ""
echo "========================================"
echo "Consensus sequences pipeline successfully completed!"
echo "Output files:"
